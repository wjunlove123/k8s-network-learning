...
# 1.prep noCNI env
cat <<EOF | kind create cluster --name=cilium-native-routing-without-kubeproxy --image=kindest/node:v1.23.4 --config=-
kind: Cluster
